				...
				<div id="reviews" class="tabContent">
					<div class="singleReview teehee">
						...
						<div class="reviewText">
							...
							<div class="review">Praesent dapibus, neque id cursus faucibus, tortor neque egestas augue, eu vulputate magna eros eu erat. Aliquam erat volutpat. Nam dui mi, tincidunt quis, accumsan porttitor, facilisis luctus, metus.</div>
						</div>
					...
					<div class="singleReview teehee">
						...
						<div class="reviewText">
							...
							<div class="review">Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc sapien ornare nisl. Phasellus pede arcu, dapibus eu, fermentum et, dapibus sed, urna.</div>
						</div>
					</div><!-- END SINGLE REVIEW -->
				</div>
				<!-- END REVIEWS -->
